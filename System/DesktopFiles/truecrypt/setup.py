...
PROG = "truecrypt"   # enter program name
COMMENT = "Encryption software" # enter comment
...
EXEC = "/opt/truecrypt/bin/truecrypt" # enter execution instructions
CAT =  "Utility" # enter menu category
